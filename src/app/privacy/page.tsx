    ...
    <>
      ...
      <div className="mx-auto max-w-3xl px-5 py-14 sm:py-20">
        <p className="text-sm leading-loose text-espresso">
          {shop.name}（以下「当店」）は、当店の運営するWebサイト（以下「当サイト」）における
        ...
        <section className="mt-10">
          ...
          <p className="mt-3 text-sm leading-loose text-espresso">
            当店は、お電話でのお問い合わせなどを通じてお客様の情報をお預かりする場合があります。
            取得した情報は、お問い合わせへの対応およびご連絡のためにのみ利用し、
        ...
        <section className="mt-10">
          ...
          <p className="mt-3 text-sm leading-loose text-espresso">
            当サイトでは、サイトの改善のためにアクセス解析ツールを利用する場合があります。
            これらのツールはCookieなどを利用して匿名のトラフィックデータを収集することがありますが、
            個人を特定する情報は含まれません。
          </p>
        </section>
        ...
        <section className="mt-10">
          ...
          <p className="mt-3 text-sm leading-loose text-espresso">
            当サイトには、Googleマップの埋め込みやInstagramへのリンクなど、
            外部サービスが含まれています。これらのサービスにおける個人情報の取り扱いは、
            各サービス提供者のプライバシーポリシーに従います。
          </p>
        </section>
