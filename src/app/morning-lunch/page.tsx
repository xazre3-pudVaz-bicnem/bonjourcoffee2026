        ...
        <div className="grid items-center gap-10 md:grid-cols-2 md:gap-16">
          ...
          <Reveal delay={0.1}>
            ...
            <div className="mt-6 space-y-4 text-sm leading-loose text-espresso sm:text-base">
              <p>
                モーニングは朝8時から11時まで。
                おにぎり、バインミートースト、モーニングバインミー、
                ホットケーキの中から、その日の気分で選べます。
                いずれもドリンク付きで、690円からご用意しています。
              </p>
              <p>
                おにぎりは塩・梅・おかかなどの定番から、卵黄そぼろまで十数種類。
                「朝からしっかりごはん派」も「軽くパン派」も、
                どちらも満足できる朝ごはんです。
              </p>
            </div>
            <Link
      ...
      <section className="grain bg-paper py-16 sm:py-24">
        <div className="mx-auto grid max-w-6xl items-center gap-10 px-5 md:grid-cols-2 md:gap-16">
          <Reveal className="order-2 md:order-1">
            ...
            <div className="mt-6 space-y-4 text-sm leading-loose text-espresso sm:text-base">
              <p>
                ランチは11時から14時まで。唐揚げカレーやビーフカレー、
                ポテトとドリンクが付くバインミーセットなど、
                喫茶店らしいお昼ごはんをご用意しています。
              </p>
              <p>
                バインミーはベトナム生まれのサンドイッチ。
                昔ながらの喫茶店に、少し新しい味がある。
                そんな取り合わせも、当店らしさのひとつです。
              </p>
            </div>
            <Link
              href="/menu#banhmi"
      ...
      <section className="mx-auto max-w-6xl px-5 py-16 sm:py-24">
        <div className="grid items-center gap-10 md:grid-cols-2 md:gap-16">
          ...
          <Reveal delay={0.1}>
            ...
            <div className="mt-6 space-y-4 text-sm leading-loose text-espresso sm:text-base">
              <p>
                お昼のあとは、夕方までゆっくりできるカフェタイム。
                銅板でじっくり焼き上げるホットケーキや、ケーキセット、
                パフェを、ハンドドリップの珈琲と一緒にどうぞ。
              </p>
              <p>
                営業は{shop.hours}（ラストオーダー{shop.lastOrder}）。
                買い物帰りや、沙美海岸方面へのドライブの途中の
                ひと休みにもご利用ください。
              </p>
            </div>
            <Link
