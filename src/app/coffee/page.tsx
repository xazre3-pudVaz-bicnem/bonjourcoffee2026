      ...
      <section className="mx-auto max-w-3xl px-5 py-16 sm:py-24">
        <Reveal>
          <p className="text-sm leading-loose text-espresso sm:text-base">
            むずかしい話は抜きにして、「今日も美味しいね」と言ってもらえる一杯を。
            玉島で珈琲を飲むなら、と思い出してもらえる店になれるよう、
            ぼんじゅうる珈琲は毎日同じことを、同じように丁寧に続けています。
          </p>
        </Reveal>
      </section>
        ...
        <div className="mx-auto grid max-w-6xl items-center gap-10 px-5 md:grid-cols-2 md:gap-16">
          <Reveal>
            ...
            <div className="mt-6 space-y-4 text-sm leading-loose text-espresso sm:text-base">
              <p>
                ご注文をいただいてから豆を挽き、一杯ずつハンドドリップで抽出します。
                挽きたての豆にお湯を注ぐと、ふわっとふくらんで香りが立ちのぼります。
                その香りごと楽しんでいただきたくて、淹れ置きはしていません。
              </p>
              <p>
                定番のブレンドやアメリカンのほか、ナポリやコロンビア、
                カフェインレスなど数種類をご用意。
                その日の気分で選んでみてください。
              </p>
            </div>
      ...
      <section className="mx-auto max-w-6xl px-5 py-16 sm:py-24">
        <div className="grid items-center gap-10 md:grid-cols-[2fr_3fr] md:gap-16">
          ...
          <Reveal delay={0.1} className="order-1 md:order-2">
            ...
            <div className="mt-6 space-y-4 text-sm leading-loose text-espresso sm:text-base">
              <p>
                夏に限らず人気のアイスコーヒーも、店内で仕込んだものをお出ししています。
                すっきりとした飲み口の中に、珈琲らしい香ばしさが残る味わいです。
              </p>
              <p>
                モーニングやランチのセットドリンクにも選べますので、
                食事と一緒にどうぞ。
              </p>
            </div>
          </Reveal>
        ...
        <div className="mx-auto max-w-3xl px-5 text-center">
          <Reveal>
            ...
            <div className="mt-8 space-y-4 text-sm leading-loose text-ivory/90 sm:text-base">
              <p>
                めざしているのは、日常的に飲みに来てもらえる珈琲です。
                仕事前の一杯、買い物帰りの一杯、夕方のひと休みの一杯。
              </p>
              <p>
                カウンター席もありますので、お一人でもお気軽に。
                珈琲に詳しくなくても大丈夫です。迷ったら、まずはブレンドをどうぞ。
              </p>
            </div>
          </Reveal>
        </div>
